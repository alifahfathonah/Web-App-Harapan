 <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="?page=artikel/artikel.php">
                <i class="fa fa-archive"></i> <span>Artikel</span>
              </a>
            </li>
            <li class="treeview">
              <a href="?page=sekolah/sekolah.php">
                <i class="fa fa-mortar-board"></i> <span>List Sekolah</span>
              </a>
            </li>
            <li class="treeview">
              <a href="?page=asal_sekolah/sekolah.php">
                <i class="fa fa-mortar-board"></i> <span>Asal Sekolah</span>
              </a>
            </li>
      ...
      <!-- <li class="treeview">
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-book"></i> <span>Setting</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="?page=user/user.php"><i class="fa fa-book"></i> User</a></li>
            </li></ul>
