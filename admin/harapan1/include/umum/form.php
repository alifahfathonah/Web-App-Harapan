      ...
      <div class="box-body">
        <section class="content">
          <div class="row">
            ...
            <form action="?page=umum/proses.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                <div class="span5">
                    ...
                    <div class="widget-content nopadding">
                        ...
                        <div class="control-group">
                            ...
                            <div class="form-group">
                                <input type="text" required autocomplete="off" class="form-control" name="tempat_lahir1" placeholder="Tempat / Tanggal Lahir" />
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" name="note_sekolah" placeholder="Asal Sekolah" />
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="form-group">
                                <input type="text" required autocomplete="off" class="form-control" name="n_ayah_k" placeholder="Nama Ayah Kandung" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Nama Ayah Tiri / Wali</label>
                            <div class="form-group">
                                <input type="text" required autocomplete="off" class="form-control" name="n_ayah_t" placeholder="Nama Ayah Tiri / Wali" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Tempat Lahir</label>
                            <div class="form-group">
                                <input type="text" required autocomplete="off" class="form-control" name="tempat_lahir2" placeholder="Tempat Lahir" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Tanggal Lahir</label>
                        ...
                        <div class="control-group">
                            <label class="control-label">Kewarganegaraan</label>
                            <div class="form-group">
                                <input type="text" required autocomplete="off" class="form-control" name="warga2" placeholder="Kewarganegaraan" />
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" required autocomplete="off" class="form-control" name="notel2" placeholder="No.Tlp/Hp Rumah" />
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" required autocomplete="off" class="form-control" name="notel3" placeholder="No.Tlp/Hp Kantor" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Golongan Darah</label>
                        ...
                        <div class="control-group">
                            ...
                            <div class="form-group">
                                <input type="text" required autocomplete="off" class="form-control" name="n_ibu_k" placeholder="Nama Ibu Kandung" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Nama Ibu Tiri / Wali</label>
                            <div class="form-group">
                                <input type="text" required autocomplete="off" class="form-control" name="n_ibu_t" placeholder="Nama Ibu Tiri / Wali" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Tempat Lahir</label>
                            <div class="form-group">
                                <input type="text" required autocomplete="off" class="form-control" name="tempat_lahir3" placeholder="Tempat Lahir" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Tanggal Lahir</label>
                        ...
                        <div class="control-group">
                            <label class="control-label">Kewarganegaraan</label>
                            <div class="form-group">
                                <input type="text" required autocomplete="off" class="form-control" name="warga3" placeholder="Kewarganegaraan" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Alamat Rumah</label>
                            <div class="form-group">
                                ...
                                <input type="text" required autocomplete="off" class="form-control" name="notel4" placeholder="No.Tlp/Hp Rumah" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Alamat Kantor</label>
                            <div class="form-group">
                                ...
                                <input type="text" required autocomplete="off" class="form-control" name="notel5" placeholder="No.Tlp/Hp Kantor" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Golongan Darah</label>
